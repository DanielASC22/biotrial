...
export const STUDY_CLAIMS: Record<string, Record<string, ClaimData>> = {
  "csr-2026-0042": {
    ...
    c006: { id: "c006", value: "43.2%", category: "adverse_event", tier: 3, status: "pending", confidence: 82, sourceRef: "AE_Summary_Report.pdf, Page 7", sourceSnippet: "TEAEs were reported in 181 of 424 patients (43.2%) in the active treatment arm. Most were mild to moderate in severity (Grade 1–2). Note: numerator/denominator yields 42.7%, not 43.2%.", section: "3.2 Safety Summary" },
